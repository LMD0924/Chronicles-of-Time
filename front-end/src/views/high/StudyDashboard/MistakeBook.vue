<template>
  <div class="space-y-6">
    <!-- 头部 -->
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/30 shadow-2xl shadow-rose-500/10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="bg-white dark:bg-gray-800/50 rounded-2xl p-5 border border-gray-200/50 dark:border-gray-700/50">
    ...
    <div class="bg-white dark:bg-gray-800/50 rounded-2xl p-4 border border-gray-200/50 dark:border-gray-700/50">
      <div class="flex flex-wrap gap-3">
        <select v-model="filters.subject" class="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
          <option value="">全部科目</option>
          <option v-for="subject in filterSubjects" :key="subject" :value="subject">{{ subject }}</option>
        </select>
        <select v-model="filters.mastered" class="px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
          <option value="">全部状态</option>
          <option value="false">未掌握</option>
          <option value="true">已掌握</option>
        </select>
        <button @click="fetchMistakes" class="px-4 py-2 rounded-xl bg-indigo-500 text-white text-sm">筛选</button>
        ...
        <div class="p-6">
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <p class="text-gray-600 dark:text-gray-400 text-sm mb-2">科目：{{ mistake.subjectName }} | 日期：{{ mistake.mistakeDate }}</p>
        ...
        <div class="p-6">
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <select v-model="newMistake.subjectName" class="w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <option v-for="subject in filterSubjects" :key="subject" :value="subject">{{ subject }}</option>
              </select>
            </div>
            <div>
...
const filters = reactive({ subject: '', mastered: '' })
