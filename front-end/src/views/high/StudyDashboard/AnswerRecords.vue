<template>
  <div class="space-y-6">
    <!-- 页面头部 -->
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/30 shadow-2xl shadow-blue-500/10">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div class="lg:col-span-3">
        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 border border-white/20 dark:border-gray-700/30 sticky top-24 shadow-2xl shadow-blue-500/5">
          ...
          <div class="space-y-5">
            <div>
              ...
              <select v-model="filters.subjectName" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
            ...
            <div>
              ...
              <select v-model="filters.questionType" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
            ...
            <div>
              ...
              <select v-model="filters.isCorrect" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
            ...
            <div>
              ...
              <select v-model="filters.knowledgePoint" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
            ...
            <div>
              ...
              <div class="flex flex-col gap-2">
                <input v-model="filters.startDate" type="date" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
                <input v-model="filters.endDate" type="date" class="w-full px-5 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-sm shadow-sm hover:shadow-md transition-all focus:ring-2 focus:ring-blue-400/50">
              </div>
            </div>
            <div class="flex gap-3 pt-2">
              ...
              <button @click="resetFilters" class="flex-1 px-6 py-2.5 rounded-2xl border-0 bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm text-gray-600 dark:text-gray-400 text-sm font-semibold shadow-sm hover:shadow-md transition-all">
                🔄 重置
              </button>
            </div>
          </div>
      ...
      <div class="lg:col-span-6">
        ...
        <div v-if="statistics.total > 0" class="grid grid-cols-2 gap-4 mb-6">
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-5 border border-white/20 dark:border-gray-700/30 shadow-xl shadow-blue-500/5">
          ...
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-5 border border-white/20 dark:border-gray-700/30 shadow-xl shadow-emerald-500/5">
            <div class="text-3xl mb-2">✅</div>
          ...
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-5 border border-white/20 dark:border-gray-700/30 shadow-xl shadow-rose-500/5">
            <div class="text-3xl mb-2">❌</div>
          ...
          <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-5 border border-white/20 dark:border-gray-700/30 shadow-xl shadow-indigo-500/5">
            <div class="text-3xl mb-2">📈</div>
        ...
        <div class="bg-white dark:bg-gray-800/50 rounded-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden">
          ...
          <div v-else class="space-y-4 p-4 max-h-[800px] overflow-y-auto">
            <div v-for="(record, index) in records" :key="record.id" class="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-4 border border-gray-200/50 dark:border-gray-700/50">
              <!-- 题号 -->
              <div class="flex items-center gap-2 mb-3">
                <span class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold" :class="record.is_correct === 1 ? 'bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400'">
                ...
                <span v-if="record.knowledge_point" class="text-xs text-indigo-600 dark:text-indigo-400">{{ record.knowledge_point }}</span>
              </div>
              ...
              <!-- 解析 -->
              <div v-if="record.answer_analysis" class="bg-white dark:bg-gray-800 rounded-lg p-3 text-sm">
          ...
          <div v-if="records.length > 0" class="p-4 border-t border-gray-200/50 dark:border-gray-700/50 flex justify-between items-center">
            ...
            <div class="flex gap-2">
              ...
              <span class="px-3 py-1 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-sm">
                {{ filters.pageNum }}
              </span>
      ...
      <!-- 右侧：知识点统计 -->
      <div class="lg:col-span-3">
        <div class="bg-white dark:bg-gray-800/50 rounded-2xl p-5 border border-gray-200/50 dark:border-gray-700/50 sticky top-24">
...
const getTypeClass = (type) => {
  const map = {
    '单选': 'bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400',
    '多选': 'bg-purple-100 text-purple-600 dark:bg-purple-900/30 dark:text-purple-400',
    '判断': 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400',
    '填空': 'bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400',
    '解答': 'bg-red-100 text-red-600 dark:bg-red-900/30 dark:text-red-400'
  }
